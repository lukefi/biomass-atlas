...
<table class="table select-column standard-width waste-table" id="elainJaKasvijätteetLayerTable">
	...
	<tbody>
		<tr>
			...
			<th scope="row"><spring:message code="bma.companies_biowaste.animal_plants.020101"/></th>
			<td><input type="checkbox" name="waste" value='1057'></td>	
		</tr>
		<tr>
			<th scope="row">020102</th>
			<th scope="row"><spring:message code="bma.companies_biowaste.animal_plants.020102"/></th>
			<td><input type="checkbox" name="waste" value='1058'></td>	
		</tr>
		<tr>
			<th scope="row">020103</th>
			<th scope="row"><spring:message code="bma.companies_biowaste.animal_plants.020103"/></th>
	...
	<!-- 	<tr>
		...
		<tr>
			...
			<th scope="row"><spring:message code="bma.companies_biowaste.animal_plants.020107"/></th>
			<td><input type="checkbox" name="waste" value='1061'></td>
		</tr>
		<tr>
			<th scope="row">020199</th>
			<th scope="row"><spring:message code="bma.companies_biowaste.animal_plants.020199"/></th>
			<td><input type="checkbox" name="waste" value='1062'></td>
		</tr>
		<tr>
			<th scope="row">020201</th>
			<th scope="row"><spring:message code="bma.companies_biowaste.animal_plants.020201"/></th>
			<td><input type="checkbox" name="waste" value='1063'></td>
		</tr>
		<tr>
			<th scope="row">020202</th>
			<th scope="row"><spring:message code="bma.companies_biowaste.animal_plants.020202"/></th>
			<td><input type="checkbox" name="waste" value='1064'></td>
		</tr>
		<tr>
			<th scope="row">020203</th>
			<th scope="row"><spring:message code="bma.companies_biowaste.animal_plants.020203"/></th>
			<td><input type="checkbox" name="waste" value='1065'></td>
		</tr>
		<tr>
			<th scope="row">020299</th>
			<th scope="row"><spring:message code="bma.companies_biowaste.animal_plants.020299"/></th>
			<td><input type="checkbox" name="waste" value='1066'></td>
		</tr>
		<tr>
			<th scope="row">020301</th>
			<th scope="row"><spring:message code="bma.companies_biowaste.animal_plants.020301"/></th>
			<td><input type="checkbox" name="waste" value='1067'></td>
		</tr>
		<tr>
			<th scope="row">020303</th>
			<th scope="row"><spring:message code="bma.companies_biowaste.animal_plants.020303"/></th>
			<td><input type="checkbox" name="waste" value='1068'></td>
		</tr>
		<tr>
			<th scope="row">020304</th>
			<th scope="row"><spring:message code="bma.companies_biowaste.animal_plants.020304"/></th>
			<td><input type="checkbox" name="waste" value='1069'></td>
		</tr>
		<tr>
			<th scope="row">020399</th>
			<th scope="row"><spring:message code="bma.companies_biowaste.animal_plants.020399"/></th>
			<td><input type="checkbox" name="waste" value='1070'></td>
		</tr>
		<tr>
			<th scope="row">020499</th>
			<th scope="row"><spring:message code="bma.companies_biowaste.animal_plants.020499"/></th>
			<td><input type="checkbox" name="waste" value='1071'></td>
		</tr>
		<tr>
			<th scope="row">020501</th>
			<th scope="row"><spring:message code="bma.companies_biowaste.animal_plants.020501"/></th>
			<td><input type="checkbox" name="waste" value='1072'></td>
		</tr>
		<tr>
			<th scope="row">020599</th>
			<th scope="row"><spring:message code="bma.companies_biowaste.animal_plants.020599"/></th>
			<td><input type="checkbox" name="waste" value='1073'></td>
		</tr>
		<tr>
			<th scope="row">020601</th>
			<th scope="row"><spring:message code="bma.companies_biowaste.animal_plants.020601"/></th>
			<td><input type="checkbox" name="waste" value='1074'></td>
		</tr>
		<tr>
			<th scope="row">020602</th>
			<th scope="row"><spring:message code="bma.companies_biowaste.animal_plants.020602"/></th>
			<td><input type="checkbox" name="waste" value='1075'></td>
		</tr>
		<tr>
			<th scope="row">020701</th>
			<th scope="row"><spring:message code="bma.companies_biowaste.animal_plants.020701"/></th>
			<td><input type="checkbox" name="waste" value='1076'></td>
		</tr>
		<tr>
			<th scope="row">020702</th>
			<th scope="row"><spring:message code="bma.companies_biowaste.animal_plants.020702"/></th>
			<td><input type="checkbox" name="waste" value='1077'></td>
		</tr>
		<tr>
			<th scope="row">020704</th>
			<th scope="row"><spring:message code="bma.companies_biowaste.animal_plants.020704"/></th>
			<td><input type="checkbox" name="waste" value='1078'></td>
		</tr>
		<tr>
			<th scope="row">200108</th>
			<th scope="row"><spring:message code="bma.companies_biowaste.animal_plants.200108"/></th>
			<td><input type="checkbox" name="waste" value='1079'></td>
		</tr>
		<tr>
			<th scope="row">200125</th>
			<th scope="row"><spring:message code="bma.companies_biowaste.animal_plants.200125"/></th>
			<td><input type="checkbox" name="waste" value='1080'></td>
		</tr>
		<tr>
			<th scope="row">200201</th>
			<th scope="row"><spring:message code="bma.companies_biowaste.animal_plants.200201"/></th>
			<td><input type="checkbox" name="waste" value='1081'></td>
		</tr>
		<tr>
			<th scope="row">200302</th>
			<th scope="row"><spring:message code="bma.companies_biowaste.animal_plants.200302"/></th>
