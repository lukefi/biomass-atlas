Oskari.registerLocalization({
    ...
    "key": "Boundary",
    "value": {
    	"toolbarTooltip": "Aluehaku: määritä alue ja laske biomassa valituilta tasoilta (en)",
    	"flyout": {
    		"title": "Aluevalinta",
    		...
    		"areaTypeInfo": {
    			...
    			"description": {
	    			...
	    			"ely": "ELY-aineistona on käytetty X vuodelta Y. Biomassatasoille tiedot on arvioitu 1 km x 1 km kokoiselle ruudukolle. ELY-keskuskohtaisessa laskennassa kokonaan ELY-keskuksen sisällä sijaitsevat ruudut lasketaan mukaan täysimääräisesti. ELY-keskusalueiden rajalla sijaitsevan ruudun arvo lasketaan sen ELY-keskuksen tulokseen jonka sisällä ruudun keskipiste sijaitsee.",
