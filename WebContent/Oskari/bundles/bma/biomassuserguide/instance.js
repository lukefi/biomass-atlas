...
Oskari.clazz.define('Oskari.bma.bundle.biomassuserguide.BiomassUserGuideInstance',
    ...
    function () {
        ...
        conf.name = 'userinterface.BiomassUserGuide';
        conf.flyoutClazz = 'Oskari.bma.bundle.biomassuserguide.Flyout';
        ...
        afterStart: function (sandbox) {
            ...
            // request
            this._requestHandlers['biomassuserguide.ShowUserGuideRequest'] = Oskari.clazz.create('Oskari.bma.bundle.biomassuserguide.request.ShowUserGuideRequestHandler', sandbox, this);
            sandbox.addRequestHandler('biomassuserguide.ShowUserGuideRequest', this._requestHandlers['biomassuserguide.ShowUserGuideRequest']);
        ...
        'stop': function() {
            ...
            sandbox.removeRequestHandler('biomassuserguide.ShowUserGuideRequest', this._requestHandlers['biomassuserguide.ShowUserGuideRequest']);
